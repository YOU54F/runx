...
# exec ./build-unix.sh 'traveling-ruby-20150210-2.1.5-linux-x86_64.tar.gz'
# exec ./build-unix.sh 'traveling-ruby-20150715-2.2.2-linux-x86_64.tar.gz'
# exec ./build-unix.sh 'traveling-ruby-20210206-2.4.10-linux-x86_64.tar.gz'
